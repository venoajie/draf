...
# download halaman web, membaca halaman tanpa download, cek update realtime
import requests
...
populasi=[{'saham': 'IKAI', 'harga': '50'}, {'saham': 'IMPC', 'harga': '1340'}, {'saham': 'TOTO', 'harga': '250'}, {'saham': 'SSMS', 'harga': '1065'}, {'saham': 'SMGR', 'harga': '12550'}, {'saham': 'GGRM', 'harga': '42025'}, {'saham': 'HMSP', 'harga': '1570'},{'saham': 'NICK', 'harga': '290'}, {'saham': 'NISP', 'harga': '815'}, {'saham': 'NOBU', 'harga': '770'}, {'saham': 'OCAP', 'harga': '159'}, {'saham': 'PADI', 'harga': '50'}, 
...
#FIXME:
		...
		laba_pct=  0 if laba_rp==0 else round(laba_rp/ beli * 100,2) #%
		...
		ob_oke = min ((max (ob_oke)) , abs(min(ob_oke)))

		layak_beli = True if testing == True else laba_pct >1 and langkah < 5 and ob_oke  > 100

		print(emiten,'layak_beli',layak_beli,'harga_pembukaan ',harga_pembukaan ,'laba',laba_pct,langkah,ob_oke) #for debug purpose only, abaikan
...
#FIXME:
    ...
    <p>Source code:  <a href="http://www.realpython.com"> Real Python</a> 
